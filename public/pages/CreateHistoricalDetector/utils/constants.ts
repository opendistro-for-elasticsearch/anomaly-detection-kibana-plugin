...
export interface HistoricalDetectorFormikValues {
  name: string;
  description: string;
  index: { label: string }[];
  timeField: string;
...
export const INITIAL_HISTORICAL_DETECTOR_VALUES: HistoricalDetectorFormikValues = {
  name: '',
  description: '',
  index: [],
  timeField: '',
...
export const HISTORICAL_DETCTOR_DATE_RANGE_COMMON_OPTIONS = [
...
export enum SAVE_HISTORICAL_DETECTOR_OPTIONS {
  START = 'start',
  KEEP_STOPPED = 'keep_stopped',
}

export enum CREATE_HISTORICAL_DETECTOR_OPTIONS {
